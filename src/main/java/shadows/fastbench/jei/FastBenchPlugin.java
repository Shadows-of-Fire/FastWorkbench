...
public class FastBenchPlugin implements IModPlugin {
	...
	public void registerRecipeTransferHandlers(IRecipeTransferRegistration reg) {
		reg.addRecipeTransferHandler(ContainerFastBench.class, VanillaRecipeCategoryUid.CRAFTING, 1, 9, 10, 36);
	}

	@Override
	public ResourceLocation getPluginUid() {
		return new ResourceLocation(FastBench.MODID, "jei_plugin");
	}
